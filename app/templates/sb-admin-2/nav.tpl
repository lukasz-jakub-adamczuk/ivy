    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow mx-1">
            <a class="nav-link dropdown-toggle" href="#" id="messagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <!-- Counter - Messages -->
                {if $postman.total gt 0}<span class="postman badge badge-danger badge-counter">{$postman.total}</span>{/if}
            </a>
            <!-- Dropdown - Messages -->
            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
                ...
                {foreach from=$pm_sections item=pms key=pmsk}
                {if isset($pm_counters[$pmsk].value) and $pm_counters[$pmsk].value gt 0}
                <a class="dropdown-item d-flex align-items-center" href="{$base}/{$pms.url}">
                    <div class="dropdown-list-image mr-3">
                        <img class="rounded-circle" src="https://source.unsplash.com/Mv9hjnEUHR4/60x60" alt="">
                        <div class="status-indicator bg-success"></div>
                    </div>
                    <div>
                        <div class="text-truncate">{$pms.name}</div>
                        <div class="small text-gray-500">Checked · {$pm_counters[$pmsk].value} items</div>
                    </div>
                </a>
                {/if}
                {/foreach}
        ...
        <li class="nav-item dropdown no-arrow">
            ...
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">{$usr::get('name')}</span>
                <img class="img-profile rounded-circle" src="{$usr::get('avatar')}">
            </a>
