<div id="{$type}-image-fragment" class="_row form-group">
								...
								<div>
									<input id="form-{$type}-fragment" name="fragment[{$type}][fragment]" type="text" class="form-control" value="{$aFragmentImage.{$type}.fragment|default:''}">
								</div>
							</div>
							<div id="{$type}-image-div" class="_row form-group{if isset($aFragmentImage) and $aFragmentImage.{$type}.fragment neq ''}{else} hidden{/if}">
								<div class="_label">
									<label>Podgląd</label>
								</div>
								<div>
