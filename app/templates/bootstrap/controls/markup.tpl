<div class="_row form-group">
								...
								<div{if isset($visible) and $visible eq false} class="visually-hidden"{/if}>
									<textarea id="form-markup" name="dataset[markup]" rows="10" cols="40" class="form-control" placeholder="Wpisz treść jako HTML">{$aFields.markup|stripslashes|default:''}</textarea>
								</div>
							</div>