<div class="row">
    ...
    <div{if isset($visible) and $visible eq false} class="form-component visually-hidden"{/if}>
        <textarea id="form-markup" name="dataset[markup]" rows="10" cols="40" class="form-control" placeholder="Wpisz treść jako HTML" aria-describedby="markup-help">
            {$aFields.markup|stripslashes|default:''}
        </textarea>
