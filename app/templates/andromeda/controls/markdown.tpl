<div class="row">
    ...
    <div{if isset($visible) and $visible eq false} class="form-component visually-hidden"{/if}>
        <textarea id="form-markdown" name="dataset[markdown]" rows="10" cols="40" class="form-control" placeholder="Wpisz treść jako markdown" aria-describedby="markdown-help">
            {$aFields.markdown|stripslashes|default:''}
        </textarea>
